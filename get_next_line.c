...
/*   Updated: 2018/12/05 14:36:59 by cde-moul         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int		ft_if_save(char **save, char **line)
{
	char		*tmp;
	size_t		t;
...
int		ft_if_line(char *buf, char **save, char **line)
{
	size_t	t;
	char	*tmp;
	size_t	len;
...
int		ft_no_line(char *buf, size_t t, char **save, char **line)
{
...
int		ft_boucle(int fd, char **save, char *buf, char **line)
{
	int		ret;
